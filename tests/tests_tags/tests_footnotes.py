...
from skcode.tags import (FootnoteDeclarationTreeNode,
...
class FootnoteDeclarationTagTestCase(unittest.TestCase):
    ...
    def test_tag_constant_values(self):
        ...
        self.assertEqual('footnote-%s', FootnoteDeclarationTreeNode.footnote_id_html_format)
        self.assertEqual('footnote-backref-%s', FootnoteDeclarationTreeNode.footnote_id_html_format_backref)
    ...
    def test_get_footnote_id_from_counter_once(self):
        ...
        self.assertEqual('1', tree_node.get_footnote_id_from_counter())
    ...
    def test_get_footnote_id_from_counter_increment(self):
        ...
        self.assertEqual('2', tree_node_2.get_footnote_id_from_counter())
        self.assertEqual('2', tree_node_2.get_footnote_id_from_counter())
        tree_node_3 = root_tree_node.new_child('footnote', FootnoteDeclarationTreeNode)
        self.assertEqual('3', tree_node_3.get_footnote_id_from_counter())
        self.assertEqual('3', tree_node_3.get_footnote_id_from_counter())
    ...
    def test_get_footnote_id_with_no_id_set_and_counter_disabled(self):
        ...
        root_tree_node = RootTreeNode()
        tree_node = root_tree_node.new_child('footnote', FootnoteDeclarationTreeNode, attrs={})
        output = tree_node.get_footnote_id(use_auto_generated_id=False)
...
class FootnoteReferenceTagTestCase(unittest.TestCase):
    ...
    def test_tag_constant_values(self):
        ...
        self.assertEqual('footnote-%s', FootnoteReferenceTreeNode.footnote_id_html_format)
