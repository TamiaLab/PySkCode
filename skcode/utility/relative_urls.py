...
RELATIVE_URL_BASE_ATTR_NAME = 'RELATIVE_URL_BASE'
...
def setup_relative_urls_conversion(document_tree, relative_url_base):
    ...
    assert relative_url_base, "The base URL for relative URLs conversion if mandatory."
...
def get_relative_url_base(document_tree):
    ...
    """
    return document_tree.attrs.get(RELATIVE_URL_BASE_ATTR_NAME, '')
